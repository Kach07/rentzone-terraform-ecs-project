...
resource "aws_cloudwatch_log_group" "log_group" {
  ...
  lifecycle {
    create_before_destroy = true        #terraform will destroy this before it creates a new one
  }
}
...
resource "aws_ecs_task_definition" "ecs_task_definition" {
  ...
  execution_role_arn        = aws_iam_role.ecs_task_execution_role.arn  #copied from ecs-role
  network_mode              = "awsvpc"
